  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-bold text-foreground">We couldn't find that page</h2>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong on our end. Nothing in your plan was changed. Try again, or head back home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nisaab — Personal money control" },
      {
        name: "description",
        content: "Plan your money, track spending and know what you can safely spend today.",
      },
      { name: "author", content: "Nisaab" },
      { name: "theme-color", content: "#6F4DD5" },
